...
public interface BookDaoIf {
	 ...
	 * 도서 정보 1건 입력
	 * @param map
	 * @return DuplicateException 입력하려는 도서 키(PK) 중복이 발생하는 경우
	 */
	 ...
	 * @param map
	 * @return
	 * @throws NotFoundException 수정하려는 도서 키키(PK) 값이 존재하지 않는 경우
	 */
	 ...
	 * @param book
	 * @return
	 * @throws NotFoundException 삭제하려는 도서 키키(PK) 값이 존재하지 않는 경우
	 */
